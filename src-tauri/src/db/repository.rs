...
use super::models::{
    ...
    ExternalUsageAggregateInput, LlmCallFilters, LlmCallPage, LlmCallRow, NewLlmCall,
    ProviderConfig, ProviderConfigInput, SyncSettings, SyncSettingsInput, TokenPulseHourlyPoint,
    TokenPulseSnapshot, TokenPulseWindowPosition, TopDimensionRow, UnknownPricingModel,
...
mod tests {
    ...
    use super::{
        AppSettingsInput, CustomImporterProfileInput, ExternalDatasetInput, LlmCallFilters,
        ProviderConfigInput, TokenPulseWindowPosition, TokenScopeRepository,
        GITHUB_SYNC_DATA_MODE_AGGREGATE_V3, GITHUB_SYNC_DATA_MODE_DETAIL_V2,
    };
    use crate::db::{GitHubSyncSettingsInput, GitHubSyncShardStateInput};
    ...
    async fn github_sync_settings_round_trip_and_redacts_token() {
        ...
        let saved = repository
            .save_github_sync_settings(&GitHubSyncSettingsInput {
                enabled: true,
