...
const englishMessages: Record<string, string> = {
  ...
  "数据来源": "Data Sources",
  "管理本机 Agent 和自定义 SQLite 来源。": "Manage local Agent and custom SQLite sources.",
  "多设备": "Multi-device",
  "配置 GitHub 同步和设备数据包。": "Configure GitHub sync and device packages.",
  "应用": "App",
  ...
  "配置 GitHub 同步和导入设备包。": "Configure GitHub sync and import device packages.",
  ...
  "管理语言、更新和本地显示偏好。": "Manage language, updates, and local display preferences.",
